...
class NotificationManager: NSObject, ObservableObject {
    ...
    func scheduleStockAlert(for stock: Stock, reason: AlertReason) {
    ...
    func schedulePredictionAlert(for stock: Stock, prediction: StockPrediction) {
        guard hasPermission else { return }
    ...
    private func createAlertMessage(for stock: Stock, reason: AlertReason) -> String {
    ...
    private func createPredictionAlertMessage(for stock: Stock, prediction: StockPrediction) -> String {
